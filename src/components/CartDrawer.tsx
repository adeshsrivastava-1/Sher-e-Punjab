...
----------------------------------`;
    ...
    // Clear cart and close drawer after sending order
    onClearCart();
    onClose();
  };
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-6">
            ...
            {cartItems.length > 0 && (
              <form onSubmit={handleConfirmOrder} className="space-y-4 pt-4 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-[#25D366] hover:bg-[#1EBE5B] text-white font-bold text-sm shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-all"
                >
